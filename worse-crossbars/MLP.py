...
def main():
    ...
    pickle.dump((accuracy_values, validation_accuracy_values, loss_values, validation_loss_values), open(f"../outputs/training_validation/training_validation_faultType{args.fault_type}_{args.number_hidden_layers}HL.pickle", "wb"))
    ...
    pickle.dump((percentages, accuracies, args.fault_type), open(f"../outputs/accuracies/accuracies_faultType{args.fault_type}_{args.number_hidden_layers}HL.pickle", "wb"))
