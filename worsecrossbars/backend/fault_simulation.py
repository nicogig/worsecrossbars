...
def weight_alterations(network_weights, fault_type=1, failure_percentage=0.2, extremes_list=[]):
    ...
    # It should be noted that only synapse parameters (i.e. weights, not neuron biases) are being altered. This is achieved by only modifying even-numbered layers,
