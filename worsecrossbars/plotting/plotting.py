"""
plotting.py:
A plotting module used to create and store plots.
"""
...
def accuracy_curves_plotter(
    ...
    Inputs:
        ...
        -   accuracies_list: A list of arrays.
        -   Each array contains accuracy values for each % of faulty devices.
        -   fault_type: An integer determining the type of fault.
        -   Acceptable values are 1, 2, or 3.
        -   Default: 1.
        -   fpath: The FontProperties object containing information about the font to use.
        -   Default: None.
        -   save: Boolean specifying whether the plot is to be saved to a file.
        -   labels: An array of strings containing the names of the curves to be plotted.
        -   Default: [].
        -   label_step: The step for the labels on the x-axis.
        -   Default: 10.
    Outputs:
        -   A graph, both inline (if using Jupyter)
            and as a png (if the "save" flag is set to true).
    ...
    if save:
        plt.savefig(
            str(Path.home().joinpath(
                ...
                "plots",
                "accuracies",
                f"accuracies_plot_faultType{fault_type}_{noise}N.png")),
            dpi=200)
